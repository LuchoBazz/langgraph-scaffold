...
This folder contains the implementation for the **act** LLM node of the Lang Graph Scaffold agent.
...
The act LLM node is responsible for:
...
```python
from src.nodes.llm.act.processor import ActLLMNode

# Initialize the LLM node
node = ActLLMNode(config)
